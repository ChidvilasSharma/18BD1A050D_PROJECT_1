...
//Search Ventilator by ventilatorId
app.post('/searchventilatorbyid',middleware.checkToken, (req, res) => {
    ...
    var data = db.collection("ventilators").find({ "ventilatorId": vid}).toArray().then(result => res.json(result));
});
...
app.post('/searchhospitalbyname',middleware.checkToken, (req, res) => {
 ...
 //Search hospital by hospital Id
 app.post('/searchhospitalbyId',middleware.checkToken, (req, res) => {
    var hid = req.body.hId;
    console.log("search hospital by Id");
    var data = db.collection("hospital").find({ "hId": hid}).toArray().then(result => res.json(result));
});
